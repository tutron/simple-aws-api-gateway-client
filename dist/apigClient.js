...
apigClientFactory.newClient = function () {
  ...
  apigClient.invokeApi = function (params, pathTemplate, method, additionalParams, body, callback) {
    ...
    return apiGatewayClient.makeRequest(request, authType, additionalParams, config.apiKey, callback);
  };
